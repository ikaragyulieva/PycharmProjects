...
# its main point is to represent some of the functionality of a Car. Each car contains information about its make,
# model, fuel consumption, fuel amount, and fuel capacity. Also, each Car can add some fuel to its tank by refueling
# and can travel a distance by driving. In order to be driven, our Car needs to have enough fuel. Everything in the
