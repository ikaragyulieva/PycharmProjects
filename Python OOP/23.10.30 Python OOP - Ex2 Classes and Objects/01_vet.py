...
# it should receive a name (string - the name of the vet doctor).
# It should also have an instance attribute called animals (empty list by default). There should also be 2 class
# attributes: animals (empty list) which will store the total amount of animals for all vet doctors; and space
# (5 by default, representing the total capacity of the clinic). You should create 3 additional instance methods:
