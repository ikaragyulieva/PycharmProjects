...
# You will be given that string expression on the first line in the form of numbers and operators
# separated with a single space from each other.
...
# we have this string "2 4 * 1 3 -", the first time we meet an operator (*),
# we should take all the numbers we have so far (2, 4), apply that operation to them,
